...
def range_select_passages(search_field:str, partition_names:list[str], output_fields:list[str], datas:ndarray|list[ndarray]):
...
def select_passages_to_ids(partition_names: list[str], ids: int|list[int], output_fields: list[str]):
...
def delete_passages(partition_name: str, filter:str):
